...
function myFunction() {
  ...
  if (document.body.scrollTop > 455 || document.documentElement.scrollTop > 455) {
    ...
    var images =document.getElementsByClassName("img-new-slider");


          for(var i=0;i<images.length;i++) {
              images[i].className = "slideUpX";
...
var detailsIndex = [1,1];
var slideId = ["details1", "details2"]
showDetails(1, 0);
showDetails(1, 1);

function plusDetails(n, no) {
    showDetails(detailsIndex[no] += n, no);
}

function showDetails(n, no) {
    var i;
    var x = document.getElementsByClassName(slideId[no]);
    if (n > x.length) {detailsIndex[no] = 1}
    if (n < 1) {detailsIndex[no] = x.length}
    for (i = 0; i < x.length; i++) {
        x[i].style.display = "none";
    }
    x[detailsIndex[no]-1].style.display = "block";
}




var detailsNewIndex = [1,1];
var sliderId = ["new1", "new2"]
showNewDetails(1, 0);
showNewDetails(1, 1);

function plusNewDetails(n, no) {
    showNewDetails(detailsNewIndex[no] += n, no);
}

function showNewDetails(n, no) {
    var i;
    var x = document.getElementsByClassName(sliderId[no]);
    if (n > x.length) {detailsNewIndex[no] = 1}
    if (n < 1) {detailsNewIndex[no] = x.length}
    for (i = 0; i < x.length; i++) {
        x[i].style.display = "none";
    }
    x[detailsNewIndex[no]-1].style.display = "block";
}
...
function showmore() {
          ...
          var divshow =document.getElementsByClassName("show")[0];
...
function showmoreworld() {
    
          
          var divs =document.getElementsByClassName("hide");
          var divshowworld =document.getElementsByClassName("showworld")[0];
          for(var i=0;i<divs.length;i++) {
             divs[i].style.display = "none";
             
          }
          
        divshowworld.style.display = "block";
        return false;
...
function showabout(){
          ...
          var divs =document.getElementsByClassName("hide");
          var divshowabout =document.getElementsByClassName("showabout")[0];
          for(var i=0;i<divs.length;i++) {
             divs[i].style.display = "none";
             
          }
          
        divshowabout.style.display = "block";
        return false;
 ...
 function show(){
          ...
          divshowworld.style.display = "none";
          divshowabout.style.display = "none";
          for(var i=0;i<divs.length;i++) {
